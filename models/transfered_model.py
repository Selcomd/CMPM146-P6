...
class TransferedModel(Model):
    def _define_model(self, input_shape, categories_count):
        ...
        base_model.pop()# removing the softmax layer
        base_model.pop() # removes Dense
        base_model.pop() # removes Dropout
        base_model.pop() # removes Dense   
        for layer in base_model.layers: #freez layers
            layer.trainable = False
        
        self.model = Sequential([ #add the last layers
            base_model,
